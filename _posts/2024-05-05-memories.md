...
I installed a random operating software on it that I can't recall the name of. It was fun for a few days. A few weeks later, I started my computer like every other day but this time I didn't see the familiar loading screen. What I saw was a [SMART](https://en.wikipedia.org/wiki/Self-Monitoring,_Analysis_and_Reporting_Technology) error.
